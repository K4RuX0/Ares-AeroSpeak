...
class AresStarshipNTR:
    ...
    def generate_all_files(self):
        ...
        bom_items = [
            ...
            ["Propulsion", "LH2 Turbopumps Cluster", f"{f:.1f} kg/s @ 125bar", 6000, 16000000, 6],
...
Business Case:
- Fleet Asset Valuation: $ {total_cost/1e6:.1f}M Unit Production Cost (Saved $68M vs 8-engine concept)
