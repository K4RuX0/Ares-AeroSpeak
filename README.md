...
| Parameter | Value |
| --- | --- |
| **Objective** | Transport 6 crew + 150t payload to Mars surface with Earth return |
...
| --- | --- | --- |
| Total Height | 50 m | 15-story building equivalent |
| Diameter | 9 m | Starship compatible |
| Dry Mass | 85 t | No fuel/cargo |
| Fueled Mass LEO | 905 t | 820t H2 + 85t dry |
| Payload to Mars | 150 t | 3x more than 2025 reference |
| Crew | 6 people | Long-duration mission |

### 1.2 NTR Aerospike Propulsion System
1. **Reactors**: 3x NTR Units @ 170 kN each. Total: 510 kN in vacuum.
2. **Core**: Low-enriched uranium in UC-ZrC matrix. Operating temp: 2800K.
3. **Propellant**: Liquid Hydrogen at 20K. Tanks: 820t.
4. **Isp vacuum**: 780s. 2.05x efficiency vs LOX/CH4 chemical engines.
5. **Aerospike Nozzle**: Truncated linear, Carbon-Carbon coated with ZrC.
6. **Advantages**: Automatic altitude compensation, 4° thrust vectoring, T/W >85:1.
...
| Reactor Failure | 1.2% | 3x reactors. 1 = abort | 99.99% mission safe |
...
1. **Economic**: Opens $1.4T market in asteroid mining + energy. Cost/kg drops 17x.
2. **Scientific**: 150t lab on Mars. Answers "are we alone?" in 10 years, not 100.
